...
export default function FlowList(props) {
  ...
  var onTabChange = props.onTabChange,
      ...
      rest = _objectWithoutPropertiesLoose(props, ["onTabChange", "renderTabs", "renderContent", "Table", "Tabs", "tabProps"]);
  ...
  var _renderTabs = function _renderTabs() {
    ...
    var TabsComponent = props.Tabs || FlowTabs;
    return /*#__PURE__*/React.createElement(TabsComponent, _extends({
  ...
  var _renderContent = function _renderContent() {
    ...
    var TableComponent = Table || RcTable;
    console.log(rest);
