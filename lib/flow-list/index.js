...
function FlowList(props) {
  ...
  var onTabChange = props.onTabChange,
      ...
      rest = (0, _objectWithoutPropertiesLoose2["default"])(props, ["onTabChange", "renderTabs", "renderContent", "TableComponent", "TabsComponent", "tabProps"]);
  ...
  var _renderContent = function _renderContent() {
    ...
    var Table = TableComponent || _rcTable["default"];
