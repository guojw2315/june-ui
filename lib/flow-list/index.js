...
function FlowList(props) {
  ...
  var _renderContent = function _renderContent() {
    ...
    }, active === "all" || active === "done" ? /*#__PURE__*/_react["default"].createElement(_index.CommonTable, {
      rowKey: "procInstId",
    ...
    }) : null, active === "wait" || active === "accept" ? /*#__PURE__*/_react["default"].createElement(_index.CommonTable, {
      rowKey: "taskId",
